...
from .views import UserRegistrationView, VerifyEmailView, PasswordResetRequestView,UserUpdateView, PasswordResetView,LogoutView,CustomTokenObtainPairView,ResendVerificationCode
